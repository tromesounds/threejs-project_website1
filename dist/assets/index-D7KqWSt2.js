...
#define LOW_PRECISION`),e}function ug(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Hl?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Kc?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Cn&&(e="SHADOWMAP_TYPE_VSM"),e}function hg(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Wi:case Xi:e="ENVMAP_TYPE_CUBE";break;case xs:e="ENVMAP_TYPE_CUBE_UV";break}return e}function fg(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Xi:e="ENVMAP_MODE_REFRACTION";break}return e}function dg(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Vl:e="ENVMAP_BLENDING_MULTIPLY";break;case du:e="ENVMAP_BLENDING_MIX";break;case pu:e="ENVMAP_BLENDING_ADD";break}return e}function pg(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function mg(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=ug(t),l=hg(t),u=fg(t),h=dg(t),f=pg(t),p=ng(t),g=ig(s),v=r.createProgram();let m,d,b=t.glslVersion?"#version "+t.glslVersion+`
...
`)o=0,c-=s;else{const h=Zg(u,r,o,c,t);o+=h.offsetX,a.push(h.path)}}return a}function Zg(i,e,t,n,r){const s=r.glyphs[i]||r.glyphs["?"];if(!s){console.error('THREE.Font: character "'+i+'" does not exists in font family '+r.familyName+".");return}const a=new af;let o,c,l,u,h,f,p,g;if(s.o){const v=s._cachedOutline||(s._cachedOutline=s.o.split(" "));for(let m=0,d=v.length;m<d;)switch(v[m++]){case"m":o=v[m++]*e+t,c=v[m++]*e+n,a.moveTo(o,c);break;case"l":o=v[m++]*e+t,c=v[m++]*e+n,a.lineTo(o,c);break;case"q":l=v[m++]*e+t,u=v[m++]*e+n,h=v[m++]*e+t,f=v[m++]*e+n,a.quadraticCurveTo(h,f,l,u);break;case"b":l=v[m++]*e+t,u=v[m++]*e+n,h=v[m++]*e+t,f=v[m++]*e+n,p=v[m++]*e+t,g=v[m++]*e+n,a.bezierCurveTo(h,f,p,g,l,u);break}}return{offsetX:s.ha*e,path:a}}class Rr extends Mo{constructor(e,t={}){const n=t.font;if(n===void 0)super();else{const r=n.generateShapes(e,t.size);t.depth===void 0&&(t.depth=50),t.bevelThickness===void 0&&(t.bevelThickness=10),t.bevelSize===void 0&&(t.bevelSize=8),t.bevelEnabled===void 0&&(t.bevelEnabled=!1),super(r,t)}this.type="TextGeometry"}}const us={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
    ...
    `,transparent:!0,depthWrite:!1,depthTest:!1}),Cc=new Je(new Gn(2,2),hi);Cc.frustumCulled=!1;Zi.add(Cc);const Ji=new xt;pt.add(Ji);Ji.visible=!1;const fi=new gt({uniforms:{time:{value:0},resolution:{value:new ne(Ze.width,Ze.height)},opacity:{value:0}},vertexShader:`
        varying vec2 vUv;
        void main() {
            vUv = uv;
            gl_Position = vec4(position.xy, 0.0, 1.0);
    ...
    `,transparent:!0,depthWrite:!1,depthTest:!1}),Pc=new Je(new Gn(2,2),fi);Pc.frustumCulled=!1;Ji.add(Pc);const $i=new xt;pt.add($i);$i.visible=!1;const di=new gt({uniforms:{time:{value:0},resolution:{value:new ne(Ze.width,Ze.height)},opacity:{value:0}},vertexShader:`
        varying vec2 vUv;
        void main() {
            vUv = uv;
            gl_Position = vec4(position.xy, 0.0, 1.0);
    ...
    `,transparent:!0,depthWrite:!1,depthTest:!1}),Dc=new Je(new Gn(2,2),di);Dc.frustumCulled=!1;$i.add(Dc);const s0=3,Gi=new xt;pt.add(Gi);const Lc=[];for(let i=0;i<s0;i++){const e=new Gn(.3,.3),t=new gt({uniforms:{opacity:{value:.015+Math.random()*.015}},vertexShader:`
            varying vec2 vUv;
            void main() {
                vUv = uv;
                gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `,transparent:!0,blending:Vn,side:wt,depthWrite:!1}),To=new Je(a0,Uc);To.position.set(-2.5,.5,.5);_i.add(To);const Ic=[];for(let i=0;i<6;i++){const e=.1+Math.random()*.2,t=new gi(e,32),n=new gt({uniforms:{color:{value:new Ue().setHSL(.5+Math.random()*.15,.6,.7)},opacity:{value:.03+Math.random()*.04}},vertexShader:`
            varying vec2 vUv;
            void main() {
                vUv = uv;
                gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `,transparent:!0,blending:Vn,side:wt,depthWrite:!1}),Nc=[];for(let i=0;i<3;i++){const e=new Gn(14,2,60,12),t=new Je(e,o0.clone());t.position.set(0,2.5+i*1,-2-i*.5),t.rotation.x=-.2+i*.08,t.userData.phaseOffset=i*.5,Ts.add(t),Nc.push(t)}const bt=new xt;pt.add(bt);bt.position.set(-2,0,0);let vs=null,ro=null;ro=new qh({color:13421772,metalness:1,roughness:.1,envMapIntensity:2});const dn=new xt;pt.add(dn);const ji=[];let un=-1,Fc=-1;const hr={radius:3.2,startAngle:Math.PI*.22,endAngle:Math.PI*-.22};function l0(){return new gt({uniforms:{time:{value:0},opacity:{value:.06}},vertexShader:`
            varying vec2 vUv;
            varying vec3 vPosition;
            void main() {
                vUv = uv;
        ...
        `,transparent:!0,side:wt})}function c0(i,e,t,n){const r=new xt;r.userData.section=i,r.userData.index=e;const s=hr.startAngle-hr.endAngle,a=hr.startAngle-e/(t-1)*s,o=Math.cos(a)*hr.radius,c=Math.sin(a)*hr.radius;r.userData.basePosition=new L(o,c,0),r.userData.baseY=c,r.userData.angle=a;const l=3.2,u=.6,h=.08,f=new mn;f.moveTo(-l/2+h,-u/2),f.lineTo(l/2-h,-u/2),f.quadraticCurveTo(l/2,-u/2,l/2,-u/2+h),f.lineTo(l/2,u/2-h),f.quadraticCurveTo(l/2,u/2,l/2-h,u/2),f.lineTo(-l/2+h,u/2),f.quadraticCurveTo(-l/2,u/2,-l/2,u/2-h),f.lineTo(-l/2,-u/2+h),f.quadraticCurveTo(-l/2,-u/2,-l/2+h,-u/2);const p=new Tt({color:0,transparent:!0,opacity:.15}),g=new Je(new Nn(f),p);g.position.z=-.002,r.add(g);const v=l0(),m=new Je(new Nn(f),v);r.add(m);const d=new Tt({color:16777215,transparent:!0,opacity:.03}),b=new Je(new Nn(f),d);b.position.z=.001,r.add(b);const E=f.getPoints(40),M=new mi({color:16777215,transparent:!0,opacity:.5}),D=new Ss(new Mt().setFromPoints(E.map(le=>new L(le.x,le.y,.002))),M);r.add(D);const P=new mi({color:16777215,transparent:!0,opacity:.4}),R=new $a(new Mt().setFromPoints([new L(-l/2+.15,u/2-.04,.003),new L(l/2-.15,u/2-.04,.003)]),P);r.add(R);const w=new mn,S=l+.25,x=u+.2,A=.12;w.moveTo(-S/2+A,-x/2),w.lineTo(S/2-A,-x/2),w.quadraticCurveTo(S/2,-x/2,S/2,-x/2+A),w.lineTo(S/2,x/2-A),w.quadraticCurveTo(S/2,x/2,S/2-A,x/2),w.lineTo(-S/2+A,x/2),w.quadraticCurveTo(-S/2,x/2,-S/2,x/2-A),w.lineTo(-S/2,-x/2+A),w.quadraticCurveTo(-S/2,-x/2,-S/2+A,-x/2);const O=new Tt({color:16777215,transparent:!0,opacity:0,blending:Vn,depthWrite:!1}),z=new Je(new Nn(w),O);z.position.z=-.005,r.add(z);const B=new xt;B.position.set(-l/2-.55,0,0);const H=new Je(new So(.16,.22,32),new Tt({color:16777215,transparent:!0,opacity:.55,side:wt}));B.add(H);const V=new Je(new gi(.12,32),new Tt({color:16777215,transparent:!0,opacity:.15}));V.position.z=.001,B.add(V);const Y=new Je(new gi(.04,16),new Tt({color:16777215,transparent:!0,opacity:.85}));Y.position.z=.002,B.add(Y);const W=new Je(new gi(.32,32),new Tt({color:16777215,transparent:!0,opacity:.06,blending:Vn}));W.position.z=-.001,B.add(W),r.add(B);const oe=new $a(new Mt().setFromPoints([new L(-l/2-.3,0,0),new L(-l/2+.05,0,0)]),new mi({color:16777215,transparent:!0,opacity:.2}));if(r.add(oe),n){const le=new Rr(i.label,{font:n,size:.16,depth:.003,curveSegments:12,bevelEnabled:!1});le.computeBoundingBox();const ve=le.boundingBox,Pe=ve.max.y-ve.min.y,Ke=[0,.03,.03,.03,0][e]||0,qe=-Pe/2-ve.min.y-Ke,K=-l/2+.2,Q=le.clone(),xe=new Tt({color:0,transparent:!0,opacity:.6}),Re=new Je(Q,xe);Re.position.set(K+.01,qe-.01,.002),r.add(Re);const Se=new Tt({color:16777215,transparent:!0,opacity:1}),We=new Je(le,Se);We.position.set(K,qe,.004),r.add(We),r.userData.textMat=Se,r.userData.shadowMat=xe}return r.userData={...r.userData,backing:g,backingMat:p,fill:m,iridescentMat:v,fillOverlay:b,fillMat:d,border:D,borderMat:M,highlight:R,highlightMat:P,glow:z,glowMat:O,discGroup:B,discRing:H,discInner:V,discDot:Y,discGlowMesh:W,connector:oe,width:l,height:u,hoverProgress:0},r.position.set(o,c,0),r}const Bn=new xt;pt.add(Bn);Bn.visible=!1;const gn=[];function u0(i,e,t,n,r=!1){const s=new xt;s.userData.linkData=i,s.userData.index=e,s.userData.isBackButton=r;const a=3,o=.6,c=.15,l=0,u=2.8-e*(o+c);s.userData.basePosition=new L(l,u,0),s.userData.baseY=u;const h=new mn,f=.05;h.moveTo(-a/2+f,-o/2),h.lineTo(a/2-f,-o/2),h.quadraticCurveTo(a/2,-o/2,a/2,-o/2+f),h.lineTo(a/2,o/2-f),h.quadraticCurveTo(a/2,o/2,a/2-f,o/2),h.lineTo(-a/2+f,o/2),h.quadraticCurveTo(-a/2,o/2,-a/2,o/2-f),h.lineTo(-a/2,-o/2+f),h.quadraticCurveTo(-a/2,-o/2,-a/2+f,-o/2);const p=new Tt({color:65348,transparent:!0,opacity:.15,side:wt,depthWrite:!1}),g=new Je(new Nn(h),p);g.renderOrder=1,s.add(g);const v=h.getPoints(30),m=new mi({color:65348,transparent:!0,opacity:.8}),d=new Ss(new Mt().setFromPoints(v.map(b=>new L(b.x,b.y,.002))),m);if(d.renderOrder=2,s.add(d),n){const b=r?"< HYPSOSIS":i.label,E=new Rr(b,{font:n,size:.14,depth:.001,curveSegments:6,bevelEnabled:!1});E.computeBoundingBox();const M=E.boundingBox,D=M.max.x-M.min.x,P=M.max.y-M.min.y,R=new Tt({color:65348,transparent:!0,opacity:1}),w=new Je(E,R);w.position.set(-D/2,-P/2,.003),w.renderOrder=3,s.add(w),s.userData.textMat=R}return s.userData.windowMat=p,s.userData.borderMat=m,s.userData.width=a,s.userData.height=o,s.userData.hoverProgress=0,s.position.set(l,u,0),s.visible=!1,s}const zn=new xt;pt.add(zn);zn.visible=!1;const _n=[];function h0(i,e,t,n,r=!1){const s=new xt;s.userData.linkData=i,s.userData.index=e,s.userData.isBackButton=r;const a=3,o=.6,c=.15,l=0,u=2.8-e*(o+c);s.userData.basePosition=new L(l,u,0),s.userData.baseY=u;const h=new mn,f=.05;h.moveTo(-a/2+f,-o/2),h.lineTo(a/2-f,-o/2),h.quadraticCurveTo(a/2,-o/2,a/2,-o/2+f),h.lineTo(a/2,o/2-f),h.quadraticCurveTo(a/2,o/2,a/2-f,o/2),h.lineTo(-a/2+f,o/2),h.quadraticCurveTo(-a/2,o/2,-a/2,o/2-f),h.lineTo(-a/2,-o/2+f),h.quadraticCurveTo(-a/2,-o/2,-a/2+f,-o/2);const p=new Tt({color:11158783,transparent:!0,opacity:.15,side:wt,depthWrite:!1}),g=new Je(new Nn(h),p);g.renderOrder=1,s.add(g);const v=h.getPoints(30),m=new mi({color:11158783,transparent:!0,opacity:.8}),d=new Ss(new Mt().setFromPoints(v.map(b=>new L(b.x,b.y,.002))),m);if(d.renderOrder=2,s.add(d),n){const b=r?"< HYPSOSIS":i.label,E=new Rr(b,{font:n,size:.14,depth:.001,curveSegments:6,bevelEnabled:!1});E.computeBoundingBox();const M=E.boundingBox,D=M.max.x-M.min.x,P=M.max.y-M.min.y,R=new Tt({color:11158783,transparent:!0,opacity:1}),w=new Je(E,R);w.position.set(-D/2,-P/2,.003),w.renderOrder=3,s.add(w),s.userData.textMat=R}return s.userData.windowMat=p,s.userData.borderMat=m,s.userData.width=a,s.userData.height=o,s.userData.hoverProgress=0,s.position.set(l,u,0),s.visible=!1,s}const Hn=new xt;pt.add(Hn);Hn.visible=!1;const vn=[];function f0(i,e,t,n,r=!1){const s=new xt;s.userData.linkData=i,s.userData.index=e,s.userData.isBackButton=r;const a=3,o=.6,c=.15,l=0,u=2.8-e*(o+c);s.userData.basePosition=new L(l,u,0),s.userData.baseY=u;const h=new mn,f=.05;h.moveTo(-a/2+f,-o/2),h.lineTo(a/2-f,-o/2),h.quadraticCurveTo(a/2,-o/2,a/2,-o/2+f),h.lineTo(a/2,o/2-f),h.quadraticCurveTo(a/2,o/2,a/2-f,o/2),h.lineTo(-a/2+f,o/2),h.quadraticCurveTo(-a/2,o/2,-a/2,o/2-f),h.lineTo(-a/2,-o/2+f),h.quadraticCurveTo(-a/2,-o/2,-a/2+f,-o/2);const p=new Tt({color:16729190,transparent:!0,opacity:.15,side:wt,depthWrite:!1}),g=new Je(new Nn(h),p);g.renderOrder=1,s.add(g);const v=h.getPoints(30),m=new mi({color:16729190,transparent:!0,opacity:.8}),d=new Ss(new Mt().setFromPoints(v.map(b=>new L(b.x,b.y,.002))),m);if(d.renderOrder=2,s.add(d),n){const b=r?"< HYPSOSIS":i.label,E=new Rr(b,{font:n,size:.14,depth:.001,curveSegments:6,bevelEnabled:!1});E.computeBoundingBox();const M=E.boundingBox,D=M.max.x-M.min.x,P=M.max.y-M.min.y,R=new Tt({color:16720418,transparent:!0,opacity:1}),w=new Je(E,R);w.position.set(-D/2,-P/2,.003),w.renderOrder=3,s.add(w),s.userData.textMat=R}return s.userData.windowMat=p,s.userData.borderMat=m,s.userData.width=a,s.userData.height=o,s.userData.hoverProgress=0,s.position.set(l,u,0),s.visible=!1,s}new qg().load("/threejs-project_website1/fonts/Smooth_Circulars_Regular.json",i=>{const e=$t.sections.length;$t.sections.forEach((a,o)=>{const c=c0(a,o,e,i);dn.add(c),ji.push(c)});const t=[...$t.omega33Links,{id:"back",label:"< BACK",isBack:!0}];t.forEach((a,o)=>{const c=a.isBack||!1,l=u0(a,o,t.length,i,c);Bn.add(l),gn.push(l)});const n=[...$t.wyzard33Links,{id:"back",label:"< BACK",isBack:!0}];n.forEach((a,o)=>{const c=a.isBack||!1,l=h0(a,o,n.length,i,c);zn.add(l),_n.push(l)});const r=[...$t.madidas33Links,{id:"back",label:"< BACK",isBack:!0}];r.forEach((a,o)=>{const c=a.isBack||!1,l=f0(a,o,r.length,i,c);Hn.add(l),vn.push(l)});const s=new Rr("HYPSOSIS",{font:i,size:.5,depth:.15,curveSegments:12,bevelEnabled:!0,bevelThickness:.02,bevelSize:.01,bevelOffset:0,bevelSegments:5});s.computeBoundingBox(),s.center(),Si&&(ro.envMap=Si),vs=new Je(s,ro),bt.add(vs)});function d0(){const i=document.createElement("div");i.id="embed-overlay",i.style.cssText=`
        position: fixed;
        top: 0;
        left: 0;
        width: 100%;
    ...
    `,e.appendChild(t),e.appendChild(n),i.appendChild(e),document.body.appendChild(i),i}const so=d0();function Bi(i,e,t="omega33"){const n=document.getElementById("embed-content"),r=document.getElementById("embed-container");let s,a,o;t==="wyzard33"?(s="#aa44ff",a="rgba(50, 0, 80, 0.8)",o="rgba(170, 68, 255, 0.3)"):t==="madidas33"?(s="#ff4466",a="rgba(80, 0, 30, 0.8)",o="rgba(255, 68, 102, 0.3)"):(s="#00ff44",a="rgba(0, 50, 0, 0.8)",o="rgba(0, 255, 68, 0.3)"),r.style.background=a,r.style.borderColor=s,r.style.boxShadow=`0 0 30px ${o}`;const c=r.querySelector("button");if(c&&(c.style.color=s),i==="soundcloud"){let l;t==="wyzard33"?l="%23aa44ff":t==="madidas33"?l="%23ff4466":l="%2300ff44",n.innerHTML=`
        ...
        `}else if(i==="youtube"){let l="";if(e.includes("youtu.be/"))l=e.split("youtu.be/")[1].split("?")[0];else if(e.includes("youtube.com/watch"))l=e.split("v=")[1]?.split("&")[0]||"";else if(e.includes("youtube.com/@")){n.innerHTML=`
            ...
            `}so.style.display="flex"}function p0(){so.style.display="none",document.getElementById("embed-content").innerHTML=""}const fr=new sf;let Dn=-1,Ln=-1,Un=-1;function m0(){if(fr.setFromCamera(new ne(Ot.targetX,Ot.targetY),At),Qe==="main"){let i=-1;for(let e=0;e<ji.length;e++)if(fr.intersectObject(ji[e].userData.fill).length>0){i=e;break}i!==un&&(un=i,document.body.style.cursor=un>=0?"pointer":"default")}else if(Qe==="omega33"){let i=-1;for(let e=0;e<gn.length;e++){if(!gn[e].visible)continue;const t=gn[e].children.filter(r=>r.type==="Mesh");if(fr.intersectObjects(t).length>0){i=e;break}}Dn=i,document.body.style.cursor=Dn>=0?"pointer":"default"}else if(Qe==="wyzard33"){let i=-1;for(let e=0;e<_n.length;e++){if(!_n[e].visible)continue;const t=_n[e].children.filter(r=>r.type==="Mesh");if(fr.intersectObjects(t).length>0){i=e;break}}Ln=i,document.body.style.cursor=Ln>=0?"pointer":"default"}else if(Qe==="madidas33"){let i=-1;for(let e=0;e<vn.length;e++){if(!vn[e].visible)continue;const t=vn[e].children.filter(r=>r.type==="Mesh");if(fr.intersectObjects(t).length>0){i=e;break}}Un=i,document.body.style.cursor=Un>=0?"pointer":"default"}}function Oc(){const i=Date.now();if(!(i-zl<300)){if(zl=i,Qe==="main"&&un>=0){const e=ji[un].userData.section;e.id==="omega33"?Wt("omega33"):e.id==="wyzard33"?Wt("wyzard33"):e.id==="madidas33"?Wt("madidas33"):e.id==="dev"?window.open("https://hypsosis.itch.io/","_blank"):e.id==="design"&&window.open("https://www.instagram.com/hypsosis","_blank")}else if(Qe==="omega33"&&Dn>=0){const e=gn[Dn];if(e.userData.isBackButton)Wt("main");else{const t=e.userData.linkData;t.embed&&(t.id==="soundcloud"||t.id.includes("soundcloud"))?Bi("soundcloud",t.url,"omega33"):t.embed&&(t.id==="youtube"||t.id.includes("youtube"))?Bi("youtube",t.url,"omega33"):window.open(t.url,"_blank")}}else if(Qe==="wyzard33"&&Ln>=0){const e=_n[Ln];if(e.userData.isBackButton)Wt("main");else{const t=e.userData.linkData;t.embed&&(t.id==="soundcloud"||t.id.includes("soundcloud")||t.id==="murder-bootleg")?Bi("soundcloud",t.url,"wyzard33"):t.embed&&(t.id==="youtube"||t.id.includes("youtube"))?Bi("youtube",t.url,"wyzard33"):window.open(t.url,"_blank")}}else if(Qe==="madidas33"&&Un>=0){const e=vn[Un];if(e.userData.isBackButton)Wt("main");else{const t=e.userData.linkData;t.embed&&(t.id==="soundcloud"||t.id.includes("soundcloud")||t.id==="drop-da-baes")?Bi("soundcloud",t.url,"madidas33"):t.embed&&(t.id==="youtube"||t.id.includes("youtube"))?Bi("youtube",t.url,"madidas33"):window.open(t.url,"_blank")}}}}let zl=0;window.addEventListener("click",Oc);window.addEventListener("touchend",Oc);function Wt(i){if(i!==Qe&&!(Qt&&Math.abs(ct-cn)>.3)){if(Qt=!0,Bn.visible=!1,zn.visible=!1,Hn.visible=!1,Zi.visible=!1,Ji.visible=!1,$i.visible=!1,i==="omega33"){Qe="omega33",cn=1,Bn.visible=!0,Zi.visible=!0,gn.forEach(t=>{t.visible=!1,t.scale.setScalar(1)}),window.history.pushState({},"","#omega33");const e=$t.sectionColors.omega33;pi.color.copy(e)}else if(i==="wyzard33"){Qe="wyzard33",cn=1,zn.visible=!0,Ji.visible=!0,_n.forEach(t=>{t.visible=!1,t.scale.setScalar(1)}),window.history.pushState({},"","#wyzard33");const e=$t.sectionColors.wyzard33;pi.color.copy(e)}else if(i==="madidas33"){Qe="madidas33",cn=1,Hn.visible=!0,$i.visible=!0,vn.forEach(t=>{t.visible=!1,t.scale.setScalar(1)}),window.history.pushState({},"","#madidas33");const e=$t.sectionColors.madidas33;pi.color.copy(e)}else if(i==="main"){Qe="main",cn=0,window.history.pushState({},"","/");const e=$t.sectionColors.dev;pi.color.copy(e),Si&&(pt.background=Si),bt.visible=!0,dn.visible=!0}}}function tt(i,e,t){return i+(e-i)*t}function g0(i){ct=tt(ct,cn,.03),Math.abs(ct-cn)<.001&&(ct=cn,Qt=!1,cn===0?(Bn.visible=!1,zn.visible=!1,Hn.visible=!1,Zi.visible=!1,Ji.visible=!1,$i.visible=!1,Si&&(pt.background=Si),dn.children.forEach(n=>{n.traverse(r=>{r.material&&r.userData&&r.userData.originalOpacity!==void 0&&(r.material.opacity=r.userData.originalOpacity)})})):cn===1&&(pt.background=new Ue(0)));const e=14,t=10;if(At.position.z=tt(e,t,ct),ct>0&&ct<1&&dn.children.forEach(n=>{n.traverse(r=>{r.material&&r.material.opacity!==void 0&&(r.userData.originalOpacity===void 0&&(r.userData.originalOpacity=r.material.opacity),r.material.opacity=r.userData.originalOpacity*(1-ct))})}),dn.position.z=-ct*10,dn.visible=ct<.95,bt.visible=ct<.8,ct<.8){const n=tt(1,.2,ct/.8);bt.scale.setScalar(n)}Qe==="omega33"?(hi.uniforms.opacity.value=ct,hi.uniforms.time.value=i,fi.uniforms.opacity.value=0,di.uniforms.opacity.value=0):Qe==="wyzard33"?(fi.uniforms.opacity.value=ct,fi.uniforms.time.value=i,hi.uniforms.opacity.value=0,di.uniforms.opacity.value=0):Qe==="madidas33"?(di.uniforms.opacity.value=ct,di.uniforms.time.value=i,hi.uniforms.opacity.value=0,fi.uniforms.opacity.value=0):(hi.uniforms.opacity.value=0,fi.uniforms.opacity.value=0,di.uniforms.opacity.value=0),ct>0&&(yi.toneMappingExposure=tt(.7,.1,ct)),Qe==="omega33"&&gn.forEach((n,r)=>{const s=r*.05,a=Math.max(0,Math.min(1,(ct-.3-s)*3));if(n.visible=a>.01,Qt){const o=tt(.5,1,a);n.scale.setScalar(o),n.position.x=n.userData.basePosition.x,n.position.y=n.userData.basePosition.y+(1-a)*.5,n.position.z=0,n.userData.windowMat&&(n.userData.windowMat.opacity=.15*a),n.userData.borderMat&&(n.userData.borderMat.opacity=.8*a)}}),Qe==="wyzard33"&&_n.forEach((n,r)=>{const s=r*.05,a=Math.max(0,Math.min(1,(ct-.3-s)*3));if(n.visible=a>.01,Qt){const o=tt(.5,1,a);n.scale.setScalar(o),n.position.x=n.userData.basePosition.x,n.position.y=n.userData.basePosition.y+(1-a)*.5,n.position.z=0,n.userData.windowMat&&(n.userData.windowMat.opacity=.15*a),n.userData.borderMat&&(n.userData.borderMat.opacity=.8*a)}}),Qe==="madidas33"&&vn.forEach((n,r)=>{const s=r*.05,a=Math.max(0,Math.min(1,(ct-.3-s)*3));if(n.visible=a>.01,Qt){const o=tt(.5,1,a);n.scale.setScalar(o),n.position.x=n.userData.basePosition.x,n.position.y=n.userData.basePosition.y+(1-a)*.5,n.position.z=0,n.userData.windowMat&&(n.userData.windowMat.opacity=.15*a),n.userData.borderMat&&(n.userData.borderMat.opacity=.8*a)}}),_i.visible=ct<.3,Ts.visible=ct<.3,Gi.visible=ct<.3}function _0(i){if(Qe!=="main")return;const e=.4;ji.forEach((t,n)=>{const r=t.userData,s=n===un,a=n===Fc,o=s?1:0;r.hoverProgress=tt(r.hoverProgress,o,.15);const c=Math.max(r.hoverProgress,a?.4:0),l=1+r.hoverProgress*.18;t.scale.setScalar(l);let u=0;if(un!==-1&&n!==un){const p=ji[un].userData.hoverProgress;n<un?u=e*p:u=-e*p}const h=r.basePosition;t.position.x=h.x,t.position.y=tt(t.position.y,h.y+u,.12),t.position.z=0,r.iridescentMat&&(r.iridescentMat.uniforms.time.value=i,r.iridescentMat.uniforms.opacity.value=.04+c*.08),r.fillMat.opacity=.03+c*.06,r.backingMat.opacity=.15+c*.1,r.borderMat.opacity=.3+c*.3,r.highlightMat.opacity=.25+c*.3,r.glowMat.opacity=c*.15,r.connector.material.opacity=.15+c*.35,r.discRing.material.opacity=.6+c*.35,r.discInner.material.opacity=.2+c*.3,r.discGlowMesh.material.opacity=.08+c*.25,r.discGroup.rotation.z+=s?.04:.004;const f=1+r.hoverProgress*.25;r.discGroup.scale.setScalar(f),r.textMat&&(r.textMat.opacity=1),r.shadowMat&&(r.shadowMat.opacity=.6)})}function v0(i){if(Qe!=="omega33"||Qt)return;const e=.35;gn.forEach((t,n)=>{const r=t.userData,a=n===Dn?1:0;r.hoverProgress=tt(r.hoverProgress||0,a,.15);const o=r.hoverProgress,c=1+r.hoverProgress*.15;t.scale.setScalar(c);let l=0;if(Dn!==-1&&n!==Dn){const h=gn[Dn].userData.hoverProgress||0;n<Dn?l=e*h:l=-e*h}const u=r.basePosition;if(t.position.x=u.x,t.position.y=tt(t.position.y,u.y+l,.12),t.position.z=0,r.windowMat&&(r.windowMat.opacity=.05+o*.35),r.borderMat&&(r.borderMat.opacity=.6+o*.4),r.textMat){const h=tt(0,.1,o),f=tt(1,.2,o),p=tt(.27,.07,o);r.textMat.color.setRGB(h,f,p)}})}function x0(i){if(Qe!=="wyzard33"||Qt)return;const e=.35;_n.forEach((t,n)=>{const r=t.userData,a=n===Ln?1:0;r.hoverProgress=tt(r.hoverProgress||0,a,.15);const o=r.hoverProgress,c=1+r.hoverProgress*.15;t.scale.setScalar(c);let l=0;if(Ln!==-1&&n!==Ln){const h=_n[Ln].userData.hoverProgress||0;n<Ln?l=e*h:l=-e*h}const u=r.basePosition;if(t.position.x=u.x,t.position.y=tt(t.position.y,u.y+l,.12),t.position.z=0,r.windowMat&&(r.windowMat.opacity=.05+o*.35),r.borderMat&&(r.borderMat.opacity=.6+o*.4),r.textMat){const h=tt(.67,.2,o),f=tt(.27,.1,o),p=tt(1,.3,o);r.textMat.color.setRGB(h,f,p)}})}function M0(i){if(Qe!=="madidas33"||Qt)return;const e=.35;vn.forEach((t,n)=>{const r=t.userData,a=n===Un?1:0;r.hoverProgress=tt(r.hoverProgress||0,a,.15);const o=r.hoverProgress,c=1+r.hoverProgress*.15;t.scale.setScalar(c);let l=0;if(Un!==-1&&n!==Un){const h=vn[Un].userData.hoverProgress||0;n<Un?l=e*h:l=-e*h}const u=r.basePosition;if(t.position.x=u.x,t.position.y=tt(t.position.y,u.y+l,.12),t.position.z=0,r.windowMat&&(r.windowMat.opacity=.05+o*.35),r.borderMat&&(r.borderMat.opacity=.6+o*.4),r.textMat){const h=tt(1,.3,o),f=tt(.13,.05,o),p=tt(.13,.05,o);r.textMat.color.setRGB(h,f,p)}})}function S0(i){bt.position.x=tt(bt.position.x,-2+Math.sin(i*.25)*.1,.02),bt.position.y=tt(bt.position.y,Math.sin(i*.35)*.15,.02),bt.position.z=Math.sin(i*.2)*.1;const e=Ot.x*.5,t=-Ot.y*.3;bt.rotation.y=tt(bt.rotation.y,e,.08),bt.rotation.x=tt(bt.rotation.x,t,.08),vs&&(vs.rotation.z=Math.sin(i*.4)*.02)}function y0(i){Lc.forEach(e=>{const t=e.userData;e.position.x=t.basePos.x+Math.sin(i*t.orbitSpeed+t.phase)*t.orbitRadius,e.position.y=t.basePos.y+Math.cos(i*t.orbitSpeed*.7+t.phase)*t.orbitRadius*.6,e.position.z=t.basePos.z+Math.sin(i*t.orbitSpeed*.5+t.phase*2)*.5,e.lookAt(At.position);const n=.8+Math.sin(i*t.speed+t.phase)*.2;e.material.uniforms.opacity.value=(.015+Math.random()*.005)*n})}function E0(i){const e=.8+Math.sin(i*1.5)*.2;To.scale.setScalar(e),Uc.uniforms.opacity.value=.08*e,Ic.forEach(t=>{const n=.7+Math.sin(i*2+t.userData.t*10)*.3;t.material.uniforms.opacity.value=t.userData.baseOpacity*n,t.rotation.z=i*.1})}function T0(i){Nc.forEach((e,t)=>{e.material.uniforms.time.value=i+e.userData.phaseOffset,e.position.x=Math.sin(i*.1+t)*.5})}function b0(){Ot.x=tt(Ot.x,Ot.targetX,.05),Ot.y=tt(Ot.y,Ot.targetY,.05),Qe==="main"&&(At.position.x=Ot.x*.25,At.position.y=Ot.y*.15),At.lookAt(0,0,0)}function w0(){Bl+=15e-5,pt.backgroundRotation&&(pt.backgroundRotation.y=Bl)}function A0(){gn.forEach((i,e)=>{const t=i.userData.height||.6,n=.15,r=0,s=2.8-e*(t+n);i.userData.basePosition.set(r,s,0),i.userData.baseY=s,Qe==="omega33"&&!Qt&&(i.position.x=r,i.position.y=s)})}function R0(){_n.forEach((i,e)=>{const t=i.userData.height||.6,n=.15,r=0,s=2.8-e*(t+n);i.userData.basePosition.set(r,s,0),i.userData.baseY=s,Qe==="wyzard33"&&!Qt&&(i.position.x=r,i.position.y=s)})}function C0(){vn.forEach((i,e)=>{const t=i.userData.height||.6,n=.15,r=0,s=2.8-e*(t+n);i.userData.basePosition.set(r,s,0),i.userData.baseY=s,Qe==="madidas33"&&!Qt&&(i.position.x=r,i.position.y=s)})}function Bc(){Ze.width=window.innerWidth,Ze.height=window.innerHeight,At.aspect=Ze.width/Ze.height,At.updateProjectionMatrix(),yi.setSize(Ze.width,Ze.height),Eo.setSize(Ze.width,Ze.height),hi.uniforms.resolution.value.set(Ze.width,Ze.height),fi.uniforms.resolution.value.set(Ze.width,Ze.height),di.uniforms.resolution.value.set(Ze.width,Ze.height);const i=Ze.width/Ze.height;if(Ze.width<768){const e=Math.min(1.1,.7+i*.5);At.fov=55,At.updateProjectionMatrix(),bt.scale.setScalar(e),dn.scale.setScalar(e*.95),Gi.scale.setScalar(e),_i.scale.setScalar(e),Bn.scale.setScalar(.9),zn.scale.setScalar(.9),Hn.scale.setScalar(.9)}else Ze.width<1024?(At.fov=52,At.updateProjectionMatrix(),bt.scale.setScalar(.95),dn.scale.setScalar(.95),Gi.scale.setScalar(1),_i.scale.setScalar(1),Bn.scale.setScalar(.95),zn.scale.setScalar(.95),Hn.scale.setScalar(.95)):(At.fov=50,At.updateProjectionMatrix(),bt.scale.setScalar(1),dn.scale.setScalar(1),Gi.scale.setScalar(1),_i.scale.setScalar(1),Bn.scale.setScalar(1),zn.scale.setScalar(1),Hn.scale.setScalar(1));A0(),R0(),C0()}window.addEventListener("resize",Bc);Bc();const P0=new Sc;function zc(){requestAnimationFrame(zc);const i=P0.getElapsedTime();w0(),b0(),g0(i),S0(i),y0(i),E0(i),T0(i),m0(),_0(i),v0(),x0(),M0(),Eo.render()}zc();function D0(){const i=window.location.hash.slice(1);if(i==="omega33")setTimeout(()=>{Wt("omega33")},500);else if(i==="wyzard33")setTimeout(()=>{Wt("wyzard33")},500);else if(i==="madidas33")setTimeout(()=>{Wt("madidas33")},500);else{const e=$t.sections.findIndex(t=>t.id===i);if(e>=0){Fc=e;const t=$t.sectionColors[i];t&&($t.currentColor.copy(t),pi.color.copy(t))}}}window.addEventListener("hashchange",()=>{const i=window.location.hash.slice(1);i==="omega33"&&Qe!=="omega33"?Wt("omega33"):i==="wyzard33"&&Qe!=="wyzard33"?Wt("wyzard33"):i==="madidas33"&&Qe!=="madidas33"?Wt("madidas33"):!i&&Qe!=="main"&&Wt("main")});D0();console.log("Hypsosis Hub v9 - Omega33 + Wyzard33 + Madidas33 Sections");
